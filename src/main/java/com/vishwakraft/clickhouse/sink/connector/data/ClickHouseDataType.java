...
public enum ClickHouseDataType {
    ...
    Int8(Byte.class, false, true, true, 1, 3, 0, 0, 0, false, 0x07,"BYTE", "INT1", "INT1 SIGNED", "TINYINT",
            "TINYINT SIGNED"),
    UInt8(DataTypeUInt8.class, false, true, false, 1, 3, 0, 0, 0, false,0x01, "INT1 UNSIGNED", "TINYINT UNSIGNED"),
    Int16(Short.class, false, true, true, 2, 5, 0, 0, 0, false, 0x08,"SMALLINT", "SMALLINT SIGNED"),
    UInt16(DataTypeUInt16.class, false, true, false, 2, 5, 0, 0, 0, false, 0x02,"SMALLINT UNSIGNED", "YEAR"),
    ...
    UInt32(DataTypeUInt32.class, false, true, false, 4, 10, 0, 0, 0, false, 0x03, "INT UNSIGNED", "INTEGER UNSIGNED",
            "MEDIUMINT UNSIGNED"),
    ...
    UInt64(DataTypeUInt64.class, false, true, false, 8, 20, 0, 0, 0, false, 0x04, "BIGINT UNSIGNED", "BIT", "SET"),
    ...
    public static Class<?> toWiderObjectType(Class<?> javaClass) {
        if (boolean.class == javaClass) {
            javaClass = Boolean.class;
        } else if (byte.class == javaClass || Byte.class == javaClass || DataTypeUInt8.class == javaClass) {
            javaClass = Short.class;
        } else if (int.class == javaClass || Integer.class == javaClass || DataTypeUInt32.class == javaClass) {
            javaClass = Long.class;
        } else if (long.class == javaClass || Long.class == javaClass) {
            javaClass = DataTypeUInt64.class;
        } else if (short.class == javaClass || Short.class == javaClass || DataTypeUInt16.class == javaClass
    ...
    public static Class<?> toPrimitiveType(Class<?> javaClass) {
        if (Boolean.class == javaClass) {
            javaClass = boolean.class;
        } else if (Byte.class == javaClass || DataTypeUInt8.class == javaClass) {
            javaClass = byte.class;
        } else if (Integer.class == javaClass || DataTypeUInt32.class == javaClass) {
            javaClass = int.class;
        } else if (Long.class == javaClass || DataTypeUInt64.class == javaClass) {
            javaClass = long.class;
        } else if (Short.class == javaClass || DataTypeUInt16.class == javaClass || Character.class == javaClass
    ...
    public static Class<?> toWiderPrimitiveType(Class<?> javaClass) {
        if (Boolean.class == javaClass || boolean.class == javaClass) {
            javaClass = boolean.class;
        } else if (Byte.class == javaClass || DataTypeUInt8.class == javaClass || byte.class == javaClass) {
            javaClass = short.class;
        } else if (Integer.class == javaClass || DataTypeUInt32.class == javaClass || int.class == javaClass
                || Long.class == javaClass || DataTypeUInt64.class == javaClass) {
            javaClass = long.class;
        } else if (Short.class == javaClass || DataTypeUInt16.class == javaClass || short.class == javaClass
